...
#### [Play the current build of _Let's Play: Ancient Greek Punishment: The Text Adventure_](https://pippinbarr.github.io/lets-play-ancient-greek-punishment-the-text-adventure)

---

_Let's Play: Ancient Greek Punishment: The Text Adventure_ is yet another new edition in the _Let's Play: Ancient Greek Punishment_ series, each focusing on a retelling of five (kind of) mythological punishments. In _The Text Adventure_ the game is retold in the form of traditional interactive fiction.


#### Read the [Press kit](https://github.com/pippinbarr/lets-play-ancient-greek-punishment-the-text-adventure/blob/master/press/README.md) for press information
#### Read the [Process documentation](https://github.com/pippinbarr/lets-play-ancient-greek-punishment-the-text-adventure/blob/master/process/README.md) for process journal, to do list, and related work
